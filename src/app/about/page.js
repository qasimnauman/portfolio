    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-transparent to-[#0a0a0a]/50">
        ...
        <div className="w-[90%] max-w-7xl mx-auto pt-20 md:pt-32 pb-12">
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12 lg:gap-16">
            ...
            <div className="flex-1 flex flex-col gap-6 text-center lg:text-left">
              <div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-poppins-bold text-[#E8EEF7] mb-3">
                  Muhammad Qasim Nauman
                </h1>
                <p className="text-xl md:text-2xl font-poppins-semi-bold text-[#D0DDF0]/90 mb-6">
                  DevOps Engineer
                </p>
                <p className="text-base md:text-lg font-poppins-regular text-[#D0DDF0]/85 leading-relaxed">
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                <Link
                  ...
                  className="group flex items-center gap-3 px-8 py-4 bg-[#B5C6E0] text-[#0a0a0a] rounded-xl font-poppins-semi-bold hover:bg-[#E8EEF7] transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl hover:shadow-[#B5C6E0]/30 focus:outline-none focus:ring-2 focus:ring-[#B5C6E0] focus:ring-offset-2 focus:ring-offset-[#0a0a0a]"
                >
        ...
        <div className="w-[90%] max-w-7xl mx-auto pb-20 space-y-16">
          {/* Technical Skills */}
          <section>
            <h2 className="text-3xl md:text-4xl font-poppins-bold text-[#E8EEF7] mb-8 flex items-center gap-4">
